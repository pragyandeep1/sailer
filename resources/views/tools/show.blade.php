            ...
            <div class="row mb-2 align-items-center mb-3">
                <div class="col-md-9">
                    <div class="page-header">
                        <h3>Tool Information @can('edit-tools')
                                <a href="{{ route('tools.edit', $tool->id) }}" class="btn btn-primary btn-sm">Edit</a>
                            @endcan
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <div class="">
                        <div class="whitebox mb-4">
                            ...
                            {{-- {{ $tool->userInfo->contact_details }} --}}
                            {{-- {{ $tool->userInfo }} --}}
                            {{-- {{ $tool->userInfo->status }} --}}


                            {{-- {{ $tool->certifications->name ? '' }} --}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                                ...
                                {{-- <div class="col-md-6" style="line-height: 24px;">
                                    @forelse ($facilities as $id => $faciliti)
                                        @if ($assetAddress['parent_id'] == $id)
                                            <span class="text-info"> <a href="{{ route('tools.show', $id) }}"
