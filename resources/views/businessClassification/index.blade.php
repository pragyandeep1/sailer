...
@section('content')
    ...
    <div class="page-content container">
        <div class="wrapper">
            <div class="row align-items-center">
                <div class="col-md-9">
                    <div class="page-header">
                        <h3>Business Classification List</h3>
                    </div>
                </div>
                <div class="col-md-3">
                    {{-- @can('create-business') --}}
            ...
            <div class="whitebox">
                <table class="datatable table align-middle table-nowrap table-check" id="businessClassification-table">
                    <thead>
                        <tr class="ligth">
                            <th>Sl</th>
                            <th width="25%">Name</th>
    ...
    {{-- ---------------------- Edit Mdal End--------------------- --}}
    @include('businessClassification.add')

    @push('javascript')
        <script type="text/javascript">
            $(function() {
                var i = 1;
                $('#businessClassification-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('businessclassification.index') }}",
