            ...
            <div class="row mb-2 align-items-center mb-3">
                <div class="col-md-9">
                    <div class="page-header">
                        <h3>Facility Information @can('edit-facility')
                                <a href="{{ route('facilities.edit', $facility->id) }}" class="btn btn-primary btn-sm">Edit</a>
                            @endcan
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <div class="">
                        <div class="whitebox mb-4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6" style="line-height: 24px;">
                                    @forelse ($categories as $id => $category)
                                        {{ $facility->category_id == $id ? $category : '' }}
                                    @empty
                                    @endforelse
                                </div>
                            </div>
                            ...
                            {{-- {{ $facility->userInfo->contact_details }} --}}
                            {{-- {{ $facility->userInfo }} --}}
                            {{-- {{ $facility->userInfo->status }} --}}


                            {{-- {{ $facility->certifications->name ? '' }} --}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                                ...
                                <div class="col-md-6" style="line-height: 24px;">
                                    @forelse ($facilities as $id => $faciliti)
                                        @if ($assetAddress['parent_id'] == $id)
                                            <span class="text-info"> <a href="{{ route('facilities.show', $id) }}"
