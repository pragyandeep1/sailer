...
@section('content')
    ...
    <script>
        ...
        // Set default name and code for new facility if not provided
                ...
                success: function(result) {
                    ...
                    $.each(result.states, function(key, value) {
                        $("#state-dd").append('<option value="' + value.id + '" ' +
                            (value.id == FetchstateId ? 'selected' : '') + '>' + value.name + '</option>');
                    });
                ...
                success: function(res) {
                    ...
                    $.each(res.cities, function(key, value) {
                        $("#city-dd").append('<option value="' + value.id + '" ' +
                            (value.id == FetchcityId ? 'selected' : '') + '>' + value.name + '</option>');
                    });
                }
            });
        });
        ...
        // Toggle dropdowns based on radio input selection
        ...
        // Update address when parent facility changes
        $('#parent_id').change(function() {
            ...
            if (parentId != '') {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.address) {
                            ...
                            $('#address_success').text(addressString).removeClass('text-info').addClass('text-success');
                ...
                $('#parent_address_warning').hide();
                $('#address_success').text('No address inherited.').addClass('text-info').show();
            }
        });

        // Update address when parent equipment changes
